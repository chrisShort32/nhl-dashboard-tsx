...
const { data: gamelog, isLoading: isLoadingGamelog, isError: isErrorGamelog } = useTeamGamelog({
        ...
        {isLoadingGamelog ? (
          ...
          <div className="mt-6">
              ...
              <DataTable
                  ...
                  data={gamelog}
                  columns={[
                      {label: 'Game Date', accessor: (row) => row.game.gameDate, key: 'game_date', className: 'font-bold'},
                      {label: 'Opponent', accessor: (row) => row.opponent.abbreviation, key: 'opponent_abbrev'},
                      {label: 'G', key: 'goals'},
                      {label: 'GA', key: 'goalsAgainst'},
                      {label: 'W/L', key: 'win', format: (value) => value === true ? value='W' : value='L'},
